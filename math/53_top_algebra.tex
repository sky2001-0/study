...
\lem{直積と連続}{
  位相空間$X, Y, Z$について、連続写像$f \colon X \times Y \rightarrow Z$を考える。

  このとき、$\forall x \in X$について写像$Y \ni y \mapsto f(x, y) \in Z$は連続である。
}{
  \thmref{連続と点連続}より、
  \eq*{
    \forall \qty(x, y) \in X \times Y \forall B_Z \in \mathcal{B}_Z(f(x, y)) \exists B_X \in \mathcal{B}_X(x) \exists B_Y \in \mathcal{B}_Y(y) \qty(f(B_X \times B_Y) \subset B_Z)
  }

  したがって$\forall x \in X$について
  \eq*{
    \forall y \in Y \forall B_Z \in \mathcal{B}_Z(f(x, y)) \exists B_Y \in \mathcal{B}_Y(y) \qty(f(\qty{x} \times B_Y) \subset B_Z)
  }
  \thmref{連続と点連続}より連続。
}
...
\dfn{位相群}{
  ...
  \begin{enumerate}
    \item $\cdot \colon G \times G \rightarrow G$が連続
    \item $-1 \colon G \rightarrow G$が連続
  \end{enumerate}
}
...
\lem{位相群と連続写像}{
  位相空間$X$と位相群$G$について、連続写像$f \colon X \rightarrow G, g \colon X \rightarrow G$を考える。

  このとき、写像$f \cdot g \colon X \ni x \mapsto f(x) \cdot g(x) \in G$と、写像$\hat{f} \colon X \ni x \mapsto f(x)^{-1} \in G$は連続である。
}{
...
\dfn{位相環}{
  ...
  \begin{enumerate}
    ...
    \item $\times \colon R \times R \rightarrow R$が連続
  \end{enumerate}
}
...
\lem{位相環の条件}{
  ...
  \begin{itemize}
    \item $\times \colon R \times R \rightarrow R$は、$\qty(0_R, 0_R)$で連続。
    \item $\forall x_0 \in R$について、$R \ni x \mapsto x_0 x \in R$は、$0_R$で連続。
    \item $\forall x_0 \in R$について、$R \ni x \mapsto x x_0 \in R$は、$0_R$で連続。
  \end{itemize}
}{
  必要性は明らか。\\*
...
\lem{位相環と連続写像}{
  位相空間$X$と位相環$R$について、連続写像$f \colon X \rightarrow R, g \colon X \rightarrow R$を考える。

  このとき、写像$f \times g \colon X \ni x \mapsto f(x) \times g(x) \in G$は連続である。
}{
...
\dfn{位相体}{
  ...
  \begin{enumerate}
    ...
    \item $-1 \colon F^\times \rightarrow F^\times$が連続
  \end{enumerate}
}
...
\thm{順序群は位相群}{
  ...
  \begin{enumerate}
    \item $+ \colon G \times G \rightarrow G$
    \item $- \colon G \rightarrow G$
  \end{enumerate}
}{
...
\thmf{順序群の\textit{Hausdorff}性}{順序群のHausdorff性}{
  順序群$G$は\textit{Hausdorff}である。
}{
  $\qty{0_G} = \qty[0_G, 0_G]$より\thmref{位相群と分離}から\textit{Hausdorff}である。
}
...
\thm{順序群では全有界ならば有界}{
  ...
  全有界より$\exists Y \in 2^A \qty(\abs{Y} < \infty \land A \subset \qty{B(g)[y] \mid y \in Y})$である。
...
\thm{順序環は位相環}{
  ...
  \begin{itemize}
    \item $\times \colon R \times R \rightarrow R$
  \end{itemize}
}{
  $\qty(0_R, 0_R)$について考える。
  ...
  $\forall x_0 \in R$について、$f \colon R \ni x \rightarrow x \times x_0 \in R$を考える。
...
\thm{順序体は位相体}{
  ...
  \begin{itemize}
    \item $-1 \colon F^\times \rightarrow F^\times$
  \end{itemize}
}{
