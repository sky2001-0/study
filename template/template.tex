...
\makeatletter
  ...
  \newcommand{\axi}[2]{\begin{axiom} \textbf{#1} \par #2 \label{ax:#1} \end{axiom}}
    \newcommand{\axif}[3]{\begin{axiom} \textbf{#1} \par #3 \label{ax:#2} \end{axiom}}
  ...
  \newcommand{\eqnref}[1]{式~\eqref{eq:#1}}
  \newcommand{\figreg}[1]{（図~\ref{fig:#1}）}
  \ifthenelse{\isundefined{\chapter}}{}{
